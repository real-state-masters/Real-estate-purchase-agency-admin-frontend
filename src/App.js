...
const arrayPropperties = [
    {
      ...
      "updated_at": "23423423",
      "price": 99999993,
      "images": ['https://images.unsplash.com/photo-1580587771525-78b9dba3b914?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MXx8aG91c2V8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&w=1000&q=80'],
            ...
            <DashboardFrame>
              <InfoResults properties={arrayPropperties}/> 
              {
                arrayPropperties.map((property) => {
                  return (
                    <PropsContainer key={property.id} property={property}/>
                  )
                })
              }
            </DashboardFrame>
